...
def get_NSAT_val_data(name, random_state=42):
    if name == "SAT-10-40":
        _, val, _, _ = get_NSAT_training_data("SAT-10-40")
        return val
        ...
        val = get_NSAT_val_data("SAT-50-100")
        ...
        val = get_NSAT_val_data("SAT-3-10")
...
def get_NSAT_training_data(name, random_state=42, split_size=0.16666):
    if name == "SAT-10-40":
        path = 'path/to/data/'
    else:
        raise NotImplementedError("This type of SAT data has not been generated yet.")
